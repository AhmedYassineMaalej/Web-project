...
<!-- Cart Header -->
<header class="cart-header text-white text-center py-5">
    <div class="container">
    ...
    <?php if ($cart->isEmpty()): ?>
        <div class="text-center py-5">
            <div class="card p-5" style="background: rgba(255,255,255,0.95);">
                <div class="mb-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="64" height="64" fill="#64748b" class="bi bi-cart-x" viewBox="0 0 16 16">
                ...
                <p class="text-muted">Start adding some great deals to your cart!</p>
                <a href="/catalog" class="btn btn-primary mt-3">Browse Products 🛍️</a>
            </div>
        </div>
    <?php else: ?>
        <div class="row">
            <div class="col-md-8 cart-items-scroll">
                ...
                <div class="card shadow-sm border-0 order-summary-card">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-3">
                            ...
                            <span>$<?= number_format($cart->getTotalCost(), 2) ?></span>
                        </div>
                        <div class="d-flex justify-content-between mb-3">
                            <span>Shipping</span>
                        ...
                        <div class="d-flex justify-content-between mb-4">
                            <strong>Total</strong>
                            <strong class="text-primary fs-4">$<?= number_format($cart->getTotalCost(), 2) ?></strong>
                        </div>
